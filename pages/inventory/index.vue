<template>
  <LayoutWrapper :class="subNav">
    <!-- 筛选器 -->
    <FilterBar v-if="list_level1" level="1" :filter="list_level1" v-model="id_level1"></FilterBar>
    ...
    <LayoutCardList type="thumbnail" class="content">
      ...
      >
          <CardThumbnail :type="subNav" :info="card">
            <nuxt-link :to="`/${subNav}/${card.Id}/detail?lang=${lang}`" target="_blank"></nuxt-link>
          </CardThumbnail>
...
export default {
    ...
    data() {
        return {
            subNav: "inventory",
            api_menu: "/wiki_equip_menu",
            api_list: "/wiki_equip_list",
            list_level1: [],
            id_level1: "",
            list_level2: [],
            id_level2: "",
    ...
    watch: {
        id_level1(newID) {
            ...
            if (subObj && subObj.subMenu && subObj.subMenu.length !== 0) {
                ...
                this.id_level2 = this.list_level2 && this.list_level2.length != 0 && this.list_level2[0].id;
            }
            else {
                this.list_level2 = [];
                this.id_level2 = "";
        ...
        id_level2(newID) {
            ...
            if (subObj && subObj.subMenu && subObj.subMenu.length !== 0) {
                ...
                this.id_level3 = this.list_level3 && this.list_level3.length != 0 && this.list_level3[0].id;
            }
            else {
                this.list_level3 = [];
                this.id_level3 = "";
        ...
        getMenu() {
            this.$axios.get(this.api_menu, {
                ...
                if (res.status == 200 &&
                    ...
                    this.id_level1 = this.list_level1 && this.list_level1.length != 0 && this.list_level1[0].id;
                }
            })
                .catch((err) => {
                console.error(err);
        ...
        getCardList(id) {
            this.$axios.get(this.api_list, {
                ...
                if (res.status == 200 &&
                    ...
                    console.log(JSON.parse(JSON.stringify(this.cardList)));
                }
            });
        }
    }
